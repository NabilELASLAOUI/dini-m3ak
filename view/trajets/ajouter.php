                    ...
                    <div class="col-sm-12 col-md-12 col-xs-12">
                        ...
                        <div class="page-content add-new-ride">
                            ...
                            <form action="" novalidate autocomplete="off" class="idealforms add-ride">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="VILLE_DEPART" id="first_name" class="form-control input-lg" placeholder="ville de départ" tabindex="1">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="LIEU_DEPART" id="last_name" class="form-control input-lg" placeholder="lieu de départ" tabindex="2">
                                        </div>
                                    </div>
                                </div>
                                 <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="VILLE_ARRIVE" id="first_name" class="form-control input-lg" placeholder="Vile d'arrivée" tabindex="1">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="LIEU_ARRIVE" id="last_name" class="form-control input-lg" placeholder="lieu d'arrivée" tabindex="2">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <input type="date" name="DATE_TRAJET" id="first_name" class="form-control input-lg" placeholder="Date" tabindex="1">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="HEURE" id="last_name" class="form-control input-lg" placeholder="Heure" tabindex="2">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="PRIX" id="first_name" class="form-control input-lg" placeholder="prix" tabindex="1">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <select name="NBR_PLACE_DISPONIBLE">
                                ...
                                <div class="field buttons">
                                    <button type="submit" class="btn btn-lg green-color">Ajouter</button>
                                </div>
